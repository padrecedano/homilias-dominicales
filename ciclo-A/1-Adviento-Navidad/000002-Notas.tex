...
\anotecontent{id2}{\label{id2a} \DPPL, n. 96.}

\anotecontent{id2}{\label{id2} NUALC n. 40.}

\anotecontent{id3}{\label{id3} Cf. OLM n. 93.}

\anotecontent{id4}{\label{id4} Cf. \DHom, nn. 78-109.}

\anotecontent{id5}{\label{id5}Oficio de lecturas, Miércoles, I semana de Adviento.}

\anotecontent{id6}{\label{id6}Oficio de lecturas, Lunes, I semana de Adviento.}

\anotecontent{id6a}{\label{id6a}\DPPL, nn. 95-105.}

\anotecontent{id7}{\label{id7} Benedicto XVI, papa, \emph{Homilía}, 28 de noviembre de 2009.}
