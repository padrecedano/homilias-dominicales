...
%Remueve números de página en los inicios de parte y capítulo 
...
\newenvironment{introstyle}{%
	\setsecheadstyle{\bfseries\scshape\large\centering}
...
\newenvironment{liturgiabox}[1]{%
	\vspace*{10pt}% 
	
	\begin{mdframed} [style=liturgia,frametitle={#1}]
		\hspace{\parindent}
	}
	{\end{mdframed}}{% 
	\vspace*{\fill}%
